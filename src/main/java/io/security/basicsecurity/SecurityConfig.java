...
public class SecurityConfig {
    ...
    public UserDetailsManager users() {
        ...
        UserDetails user = User.builder()
                .username("user")
                .password("{noop}1111") //패스워드 암호화 할때 어떤 알고리즘을 썻는지 적어줌
                .roles("USER")
                .build();
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .rememberMe()
                .rememberMeParameter("remember")//remember-me 디폴트값
                .tokenValiditySeconds(3600)
                .userDetailsService(userDetailsService); //유저 계정을 조회할때
        ...
        http
                ...
                .accessDeniedHandler(new AccessDeniedHandler() {
                    ...
                    public void handle(HttpServletRequest request, HttpServletResponse response, AccessDeniedException accessDeniedException) throws IOException, ServletException {
                        response.sendRedirect("/denied"); //인증을 받은 사용자가 인가 실패 했기 때문에 따로 인증권한 설정을 안해도됨
                    }
                });
